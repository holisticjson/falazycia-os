...
const { noColors } = require("patchright-core/lib/coreBundle").iso;
const { ManualPromise, signalToPromise } = require("patchright-core/lib/coreBundle").iso;
const { escapeRegExp } = require("patchright-core/lib/coreBundle").iso;
const { toPosixPath } = require("patchright-core/lib/coreBundle").utils;
