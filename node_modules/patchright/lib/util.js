...
const debug = require("patchright-core/lib/utilsBundle").debug;
const mime = require("patchright-core/lib/utilsBundle").mime;
const minimatch = require("patchright-core/lib/utilsBundle").minimatch;
const { calculateSha1 } = require("patchright-core/lib/coreBundle").utils;
const { sanitizeForFilePath } = require("patchright-core/lib/coreBundle").utils;
const { isRegExp } = require("patchright-core/lib/coreBundle").iso;
const { parseStackFrame, stringifyStackFrames } = require("patchright-core/lib/coreBundle").iso;
const { ansiRegex, isString, stripAnsiEscapes } = require("patchright-core/lib/coreBundle").iso;
