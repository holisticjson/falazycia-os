...
- **Health check fails:** "TradingView didn't launch with the debug port — close it fully, use the tv_launch tool, try again."
...
- TradingView Desktop download: https://www.tradingview.com/desktop/
- Claude Code install: https://www.claude.com/claude-code
