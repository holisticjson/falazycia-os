...
3. **Pliki konfiguracyjne (.env):** Zaktualizuj pliki konfiguracyjnych w folderze `c:\Aplikacje MVP\Android\server\.env` na podstawie `.env.example` wprowadzając nowe wartości domen.
