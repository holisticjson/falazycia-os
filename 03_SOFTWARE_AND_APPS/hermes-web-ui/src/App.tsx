...
import HolisticBrokerPage from "@/pages/HolisticBrokerPage";
import LegalDepartmentPage from "./pages/LegalDepartmentPage";
...
const BUILTIN_ROUTES_CORE: Record<string, ComponentType> = {
  ...
  "/docs": DocsPage,
  "/kanban": KanbanPage,
  "/content": ContentFactoryPage,
  "/broker": HolisticBrokerPage,
  "/legal": LegalDepartmentPage,
  "/finance": FinancePage,
  "/antigravity": AntigravityPage,
  "/zen": ZenPage,
  "/journal": JournalPage,
  "/wiki": PlaceholderPage,
  "/notebook": PlaceholderPage,
};
...
const BUILTIN_NAV_REST: NavItem[] = [
  ...
  {
    path: "/content",
    label: "Fabryka Treści",
    icon: Sparkles,
  },
  {
    path: "/broker",
    label: "Holistic Broker",
    icon: Globe,
  },
  {
    path: "/legal",
          ...
          >
            ...
            >
              <div className="flex flex-col gap-1">
                <span className="text-[9px] font-mondwest tracking-[0.15em] text-text-tertiary uppercase">
                  LOCAL · BANGKOK
                </span>
                <Typography
                  className="font-bold text-[1.25rem] leading-[1] tracking-[0.02em] text-midground"
                  style={{ mixBlendMode: "plus-lighter" }}
                >
                  Agentic <span className="italic font-light">OS</span>
                </Typography>
              </div>
            ...
            >
              ...
              <div className="flex flex-col pb-2">
                <span className="px-5 pt-2.5 pb-1 font-mondwest text-[10px] uppercase tracking-[0.12em] text-text-tertiary">
                  MISSION CONTROL
                </span>
                <ul className="flex flex-col">
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/sessions", label: "Dashboard", icon: Database}} t={t} />
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/chat", label: "Chat z CEO", icon: MessageSquare}} t={t} />
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/kanban", label: "ADHD Kanban", icon: Activity}} t={t} />
                </ul>
              </div>
              ...
              <div className="flex flex-col pb-2">
                ...
                <ul className="flex flex-col">
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/content", label: "Fabryka Treści", icon: Star}} t={t} />
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/broker", label: "Holistic Broker", icon: Users}} t={t} />
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/legal", label: "Dział Prawny", icon: Shield}} t={t} />
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/finance", label: "Finanse", icon: BarChart3}} t={t} />
                </ul>
              </div>
              ...
              <div className="flex flex-col pb-2">
                ...
                <ul className="flex flex-col">
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/zen", label: "Tryb Zen / SOS", icon: Heart}} t={t} />
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/journal", label: "Dopamine Journal", icon: Zap}} t={t} />
                </ul>
              </div>
              ...
              <div className="flex flex-col pb-2">
                ...
                <ul className="flex flex-col">
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/wiki", label: "Baza Wiedzy", icon: BookOpen}} t={t} />
                  <SidebarNavLink closeMobile={closeMobile} item={{path: "/notebook", label: "NotebookLM", icon: FileText}} t={t} />
                </ul>
              </div>
              
              {/* Other Built-in Pages */}
              <div className="flex flex-col pb-2 border-t border-current/10 mt-2">
                <span className="px-5 pt-2.5 pb-1 font-mondwest text-[10px] uppercase tracking-[0.12em] text-text-tertiary">
                  SYSTEM
                </span>
                <ul className="flex flex-col">
                  {sidebarNav.coreItems.filter(i => !["/sessions", "/chat"].includes(i.path)).map((item) => (
                    <SidebarNavLink
