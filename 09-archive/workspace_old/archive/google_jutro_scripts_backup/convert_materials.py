...
WEEK4_DIR = os.path.join(ROOT_DIR, "Obsidian_Knowledge_Base", "Tydzień 4 -Decyzje oparte na danych i planowanie wdrożeń AI")
...
def main():
    print(f"Scanning for PDF and Excel files in {WEEK4_DIR}...")
