# PRD: System Agentowy Jaison MLM OS dla społeczności LifeWave4Life

Ten dokument określa wymagania biznesowe i techniczne (Product Requirements Document) dla inteligentnego systemu agentowego **Jaison MLM OS**, przeznaczonego do wsparcia i automatyzacji działań rekrutacyjnych oraz operacyjnych dla Partnerów Biznesowych (Brand Partners) grupy **LifeWave4Life**.
...
*   **Nowy Partner (Novice Partner):** Osoba bez doświadczenia w MLM, która obawia się odrzucenia, brakuje jej wiedzy merytorycznej o fototerapii, łatwo ulega prokrastynacji i potrzebuje prowadzenia krok po kroku.
...
*   **06:30 rano - Zapłon Biologiczny:** Agent wysyła powiadomienie zapobiegające bezmyślnemu scrollowaniu social mediów. Wymaga raportu z wykonania procedury: szklanka wody z solą kłodawską, 15 sekund tlenowego pobudzenia, zimny prysznic. Wykonanie podnosi poziom dopaminy o +250% i aktywuje energię do działania.
...
*   **Kanał Nadawczy:** Bezpośrednie połączenie z oficjalnym kanałem WhatsApp grupy **LifeWave4Life** w celu dystrybucji kluczowych ogłoszeń i aktualizacji.
...
*   **Kompletna Baza Wiedzy:** Agent ma wbudowany dostęp do pełnego Back-office LifeWave, badań naukowych o fototerapii (np. działanie peptydów GHK-Cu, technologia X39) oraz struktur biznesowych.
...
3.  **Faza 3:** Wdrożenie bazy wiedzy o fototerapii i planu kompensacyjnego LifeWave do silnika Hermesa.
4.  **Faza 4:** Uruchomienie testowych instancji CloneJobs dla administratorów i zbieranie pierwszych plików Ghost.
5.  **Faza 5:** Pełny Product Launch dla całej społeczności LifeWave4Life.
